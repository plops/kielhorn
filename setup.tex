...
from the objective. Bead~5 is far from any other beads and therefor
...
\begin{figure}[!hbt]
  ...
  \caption{Raytracing through an objective followed by a tubelens. The
    ...
    into an unscaled image. The water depth is \unit[10]{$\mu$m}. Rays
    that start in the sample with high angles do not reach the
    gaussian focus spot in the image.}
