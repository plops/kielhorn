...
\figref{fig:m_wf} shows slices of a widefield stack of a
...
\begin{figure}[H]
  ...
  \caption{Widefield stack of a three-dimensional distribution of
...
\begin{figure}[H]
  ...
  \caption{Structured illumination images of the same of the beads
    from \figref{fig:m_wf}. Of each $z-$slice four exposures with
...
\figref{fig:m_clem}). Note that two beads, that were part in the
