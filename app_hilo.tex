...
\end{align}
Due to the structure of the optical transfer function (OTF), the out
of focus light is limited to low spatial frequencies.
...
projected into the sample. For completeness I describe my
...
\begin{figure}[htb]
  ...
  \subfigure[Combined images $\hat I_\textrm{hilo}$ in k-space.]{\includegraphics[width=4cm]{../app_hilo/kihilo}}
