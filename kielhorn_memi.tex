...
\begin{titlepage}
  ...
  \hspace{4cm}\textsf{\Huge\Huge Spatio--angular microscopy}
...
F\"orster and all the other members of our group for valuable
...
(project number 2115597) the studentship on this project.  Further I
thank the Edward Rosten, Christophe Rhodes, Paul Khuong, Nikodemus
Siivola, dem Levente M\'esz\'aros and Lu\' is Oliveira, Mixa.

Finally I want to thank the authors and contributors to the following
free software projects: Linux, GCC, Emacs, SBCL, Micromanager,
