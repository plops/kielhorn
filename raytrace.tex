...
$\r'$. One could normalize it but it turns out to be useful for the
...
\section{Refraction through oil objective (from pupil into sample
  space)}
\begin{figure}[!hbt]
  \centering
...
One accounts for the immersion medium by shifting the focal plane in
