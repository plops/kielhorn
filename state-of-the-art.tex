...
also improves the axial resolution from originally $\unit[14]{\mu m}$
...
A major difference between this technique and conventional microscopy
techniques is the way the sample is mounted. Usually a specimen is
placed with a drop of embedding medium on a \unit[170]{$\mu$m} thick
coverslip. Then it is flipped onto a microscope slide and sealed with
nail varnish. This approach of mounting the sample does not work for
an ultramicroscope. There the sample has to be accessed from two
perpendicular sides. Often the specimen are embedded in an agarose
cylinder or sometimes, they are fixed in a liquid--filled chamber.
...
Ideally, points of type (A) that don't contain fluorophores should
